...
export default function Footer() {
  return (
    <footer
      class="page-footer bg-black text-white pattern-bg pb-0"
      id="page-footer"
    >
      <div class="container">
        <div class="row align-items-center">
            ...
            <div class="widget social-icons mb-20">
              <ul class="list-inline mb-0">
                <li class="list-inline-item">
                  <a
                    href="#"
                    class="ion-social-facebook-outline no-hvr-link"
                    title="Facebook"
                  ></a>
                </li>
                <li class="list-inline-item">
                  <a
                    href="#"
                    class="ion-social-twitter-outline no-hvr-link"
                    title="Twitter"
                  ></a>
                </li>
                <li class="list-inline-item">
                  <a
                    href="#"
                    class="ion-social-instagram-outline no-hvr-link"
                    title="Instagram"
                  ></a>
                </li>
              </ul>
          ...
          <div class="col-6 text-end">
            <a href="#" class="back-to-top d-inline-block mb-20">
              Back To top <span class="lnr lnr-chevron-up-circle"></span>
            </a>
          </div>
        </div>
                ...
                <div class="bg-black p-3 p-md-4">
                  ...
                  <div class="input-group">
                    <input
                      ...
                      aria-describedby="sub-btn"
                    />
                    <button class="btn btn-primary" type="button" id="sub-btn">
                      Register
                    </button>
                  </div>
                </div>
            ...
            <div class="offset-lg-4 col-md-3">
              <div class="widget contact-widget mb-30">
                <ul class="list-unstyled">
                  ...
                  <li>
                    <abbr title="Tel Phone">T:</abbr> (123) 456-789
                  </li>
                  <li>
                    <abbr title="Email">E:</abbr>{" "}
                    <a href="mailto:info@nvthemes.com">help@company.com</a>
                  </li>
                </ul>
              </div>
            </div>
